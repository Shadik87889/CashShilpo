 ...
 * Organizes the monolithic settings page into a clean tabbed interface.
 * Features the HyperVoice OS tab and the new Templates tab.
 * Updated: Adds 'Save Changes' button to all tabs.
 */
...
(function () {
  ...
  function organizeContent(settingsForm) {
    ...
    const sortElement = (element) => {
      ...
      // Templates related titles
      if (title.includes("receipt & invoice")) return "templates";
    ...
    if (saveButtonTemplate) {
      ...
      // Remove original from DOM to avoid duplicate ID issues (though it's in a hidden container)
